  ...
  myst = pkgs.st.override {
    ...
    conf = ''
      ...
      static const char *colorname[] = {
      	/* 8 normal colors */
      	[0] = "#${colors.black}", /* hard contrast: #1d2021 / soft contrast: #32302f */
      	[1] = "#${colors.red}", /* red     */
      	...
      	/* 8 bright colors */
      	[8]  = "#${colors.brightBlack}", /* black   */
      	[9]  = "#${colors.brightRed}", /* red     */
      	[10] = "#${colors.brightGreen}", /* green   */
      	[11] = "#${colors.brightYellow}", /* yellow  */
      	[12] = "#${colors.brightBlue}", /* blue    */
      	[13] = "#${colors.brightPurple}", /* magenta */
      	[14] = "#${colors.brightAqua}", /* cyan    */
      	[15] = "#${colors.brightGray}", /* white   */
      };
